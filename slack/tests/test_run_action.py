...
class TestMain:
    ...
    @patch('slack_reporter.constants.slack_constants.SlackConstants.SLACK_CHANNEL_NAME', 'test-channel')
    ...
    def test_main_success_with_reaction(self, mock_slack_client_class, mock_set_output):
        ...
        mock_slack_client.add_reaction_to_thread_by_channel_id.return_value = mock_reaction_response
    ...
    def test_main_success_with_default_reaction(self, mock_slack_client_class, mock_set_output):
    ...
    def test_main_slack_client_init_error(self, mock_exit, mock_slack_client_class):
        ...
        # Arrange
        mock_slack_client_class.side_effect = ValueError("The SLACK_BOT_TOKEN environment variable was not set")
    ...
    def test_main_reaction_failure_continues(self, mock_slack_client_class, mock_set_output):
    ...
    def test_main_add_reaction_case_insensitive(self, mock_slack_client_class, mock_set_output):
    ...
    def test_main_no_outputs_when_no_response_data(self, mock_slack_client_class, mock_set_output):
